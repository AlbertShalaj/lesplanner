...
elements.btnAiPrompt.addEventListener('click', () => {
    const prompt = `Hoi Gemini! Ik ben een les aan het ontwerpen voor mijn interactieve Lesplanner. 
Kun je deze les voor me invullen in het juiste JSON formaat?

Hier is het onderwerp: [BESCHRIJF HIER JE LES]
  ...
  "timeline": [
    {
      ...
      "subtitle": "Klassikaal",
      "time": "10 min",
      "card": { "type": "class", "title": "Klassikale Start", "description": "...", "actionType": "external_url", ... }
    }
  ],
  "workbook": { "title": "...", "instructions": "...", "solutionContent": "..." }
}

BELANGRIJK: Geef me ALLEEN de ruwe JSON code terug in een codeblok.`;

    navigator.clipboard.writeText(prompt).then(() => {
        elements.btnAiPrompt.textContent = '✅ Prompt Gekopieerd!';
